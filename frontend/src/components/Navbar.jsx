                    ...
                    <div className="flex items-center justify-between gap-x-2 group relative">
                      ...
                      <div className="absolute w-56 top-12 right-0 text-base font-medium text-gray-600 z-20 hidden group-hover:block">
                        <div className="bg-primary shadow-lg divide-y divide-gray-100 rounded flex flex-col gap-4 p-2">
                          <p className="cursor-pointer text-gray-500 hover:bg-gray-300/75   rounded-lg px-4 py-2">My Profile</p>
                          <p className="cursor-pointer text-gray-500 hover:bg-gray-300/75  rounded-lg px-4 py-2">Points</p>
                          <p onClick={() => setToken(false)} className="cursor-pointer text-red-700 hover:bg-red-100 rounded-lg px-4 py-2">Logout</p>
                        </div>
                      </div>
                    </div>
                  ) : (
